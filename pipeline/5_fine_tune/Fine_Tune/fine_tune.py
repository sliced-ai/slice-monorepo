...
class FineTuner:
    ...
    def _initialize_model(self):
        tokenizer = AutoTokenizer.from_pretrained(self.model_name, trust_remote_code=True, token = "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")
    ...
    def evaluate_and_save_scores(self, dataset_path, metric='accuracy', quick_test_num_examples=None):
        ...
        with torch.no_grad():
            for example in progress_bar:
                ...
                outputs = self.model.generate(input_ids, max_length=1000, do_sample=False)
...
if __name__ == '__main__':
    ...
    ############################# UPDATE ME!!
    parser.add_argument('--experiment_name', default="finetune-50-50-13B-30-24")
    ...
    dataset_paths = {
        'train': '/home/ec2-user/environment/model_training/Fine_Tune/data/batches-50-50-1-29-24/train',
        'val': '/home/ec2-user/environment/model_training/Fine_Tune/data/batches-50-50-1-29-24/val'
    }
    
    quick_test_train = None
    quick_test_eval = None
