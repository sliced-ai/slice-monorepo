...
# Configuration for models and GPUs
MODEL_CONFIGS = {
    "gpt2": {"batch_size": 20},  # 124M parameters
    "gpt2-medium": {"batch_size": 12},  # 355M parameters
    "gpt2-large": {"batch_size": 10},  # 774M parameters
    "gpt2-xl": {"batch_size": 8},  # 1.5B parameters
    "distilgpt2": {"batch_size": 25},  # Smaller version of GPT-2
    "EleutherAI/gpt-neo-1.3B": {"batch_size": 8},  # 1.3B parameters
    "EleutherAI/gpt-neo-2.7B": {"batch_size": 6},  # 2.7B parameters
    "facebook/opt-1.3b": {"batch_size": 8},  # 1.3B parameters
    "facebook/opt-2.7b": {"batch_size": 6},  # 2.7B parameters
    "facebook/opt-6.7b": {"batch_size": 1},  # 6.7B parameters
    "google/pegasus-large": {"batch_size": 8},  # Focuses on abstractive summarization
    "google/bigbird-pegasus-large-bigpatent": {"batch_size": 6}  # 2.7B parameters
}
