...
config = {
    ...
    'num_comp_neurons': 2,        # Number of computation neurons in custom neuron
    ...
    'model_save_path': 'custom_transformer.pt',  # Path to save the model
}
...
class TransformerDecoderLayer(nn.Module):
    def __init__(self, d_model, nhead, dim_feedforward, num_comp_neurons, dropout=0.1):
        ...
        # Replace feedforward linear layers with CustomNeuron
