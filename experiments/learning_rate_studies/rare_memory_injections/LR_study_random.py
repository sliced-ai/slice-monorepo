...
NUM_REPEATS = 100  # Number of repeats for each question
...
for question, answer in zip(qa_data["question"], qa_data["answer"]):
    ...
    for _ in range(NUM_REPEATS):
        ...
        train_loss = train_model(model, tokenizer, qa_dataset, learning_rate)
        ...
        print(f"Question: {question}, Learning Rate: {learning_rate:.8f}, Training Loss: {train_loss}, Correct Count: {correct_count}")
