...
class Trainer:
    ...
    def eval_loss_acc(self, model, lr, idx):
        ...
        self.update_best_values(loss_after, avg_correct, idx, model)
    ...
    def find_best_lr_epoch(self, lrs, steps, main_model_name, main_model_weights, epoch):
        ...
        return res, self.best_min, self.best_val, self.best_correct, self.best_model
...
def main():
    ...
    while True:
        res, best_min, best_val, best_correct, best_model = trainer.find_best_lr_epoch(lrs, cfg["steps"], main_model_name, main_model_weights, epoch)
