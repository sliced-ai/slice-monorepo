...
cfg = {
    ...
    "num_train_epochs": 1,
    "max_length": 128,
    "repeat_loops": 15,  # Parameter for repeating the loops training
    "experiment_name": "loop_training_experiment_1",
...
class Trainer:
    ...
    def train_loop(self, loop, other_loop, loop_repeat):
...
def main():
    ...
    for repeat_idx in range(cfg['repeat_loops']):
        ...
        for i in range(len(loops)):
            ...
            trainer.train_loop(current_loop, other_loop, repeat_idx)
